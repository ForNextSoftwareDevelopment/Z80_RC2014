...
;        JP   CPM_LOAD                   ; Load CP/M from compact flash 
        ...
        LD   HL,CPM_STARTING_TEXT       ; Skip loading CP/M from compact flash 
        CALL PRINT_CONSOLE              ; (it's in the source code now)
        JP   CPM_LOAD_ADDR              ; and just start CP/M 
...
SETEXT: LD      HL,(PARAMS)
        ...
        RET     
;
;   Set (HL) to point to next record number byte in fcb and (DE) to
; record count byte.
;
